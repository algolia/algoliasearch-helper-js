    ...
    return setup(indexName, dataset, config).then(function(client) {
      ...
      return helper.searchForFacetValues('f', 'a').then(function(content) {
        ...
        expect(content.facetHits).toEqual([
          {value: 'ba', safeValue: 'ba', highlighted: '<em>b</em>a', count: 3, isRefined: false},
          {value: 'bb', safeValue: 'bb', highlighted: '<em>b</em>b', count: 2, isRefined: false}
        ]);
        ...
        expect(content.facetHits).toEqual([
          {value: 'ba', safeValue: 'ba', highlighted: '<em>b</em>a', count: 1, isRefined: false},
          {value: 'bb', safeValue: 'bb', highlighted: '<em>b</em>b', count: 1, isRefined: false}
        ]);
        ...
        expect(content.facetHits).toEqual([
          {value: 'c', safeValue: 'c', highlighted: 'c', count: 2, isRefined: true},
          {value: 'x', safeValue: 'x', highlighted: 'x', count: 1, isRefined: false},
          {value: 'y', safeValue: 'y', highlighted: 'y', count: 1, isRefined: false}
        ]);
      });
    });
  });
  ...
  function() {
    return setup(indexName, dataset, config).then(function(client) {
      ...
      return helper.searchForFacetValues('f', 'a').then(function(content) {
        ...
        expect(content.facetHits).toEqual([
          {value: 'b', safeValue: 'b', highlighted: 'b', count: 2, isRefined: false},
          {value: 'c', safeValue: 'c', highlighted: 'c', count: 2, isRefined: true},
          {value: 'd', safeValue: 'd', highlighted: 'd', count: 1, isRefined: false},
          {value: 'x', safeValue: 'x', highlighted: 'x', count: 1, isRefined: false},
          {value: 'y', safeValue: 'y', highlighted: 'y', count: 1, isRefined: false}
        ]);
      });
