...
test('getRefinements(facetName) returns a refinement(exlude) when a facet exclusion is set', function() {
...
test('getRefinements(facetName) returnes a refinement(tag) when a tag is set', function() {
